...
Dim UseSolenoids
Const UsePROC = 1           '0 = Use VPinMAME ROM, 1 = Use P-ROC/pyprocgame

If UsePROC = 1 Then
    UseSolenoids = 1
    LoadProc "01560000", "WPC.VBS", 3.36
Else
    UseSolenoids = 2
...
'****************************************************************
'Main definitions
'UseSolenoids is declared and set above in the PROC/VPM branch
...
Sub Table1_Init()
	...
	With Controller
		...
		Err.Clear
		.Run
		If Err Then MsgBox "Run() FAILED: " & Err.Number & " - " & Err.Description
		On Error Goto 0
	End With
